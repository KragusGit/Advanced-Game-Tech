...
namespace NCL {
	...
	public:
		...
		static bool CheckForSpearation(const OBBVolume& volumeA, const SphereVolume& volumeB, const Transform& worldTransformA, const Transform& worldTransformB, Vector3 dir, CollisionInfo& colInfo);

		static bool CheckForSpearation(const OBBVolume& volumeA, const OBBVolume& volumeB, const Transform& worldTransformA, const Transform& worldTransformB, Vector3 dir, CollisionInfo& info);

		static Vector3 ObbSupport(const Transform& worldTransform, const SphereVolume& volume, Vector3 worldDir);

		static Vector3 ObbSupport(const Transform& worldTransform, const OBBVolume& volumeA, Vector3 worldDir);
